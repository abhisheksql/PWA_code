          ...
          if (response.status === 200 && response.data.valid) {
            ...
            if (isNumeric(username)) {
              ...
              if (otpResponse.status == 200) {
                ...
                router.push(
                  `/login/teacher/mobileotp?data=${username}&action=login`
                );
              } else {
                console.error(
              ...
              router.push(`/login/teacher/emailpass?username=${username}`);
            }
          } else {
            if (isNumeric(username)) {
                ...
                <div className="item">
                  <div className="left-side">
                    <div className="title">
                      ...
                      <p>
                        Experience the profound joy and fulfillment of shaping
                ...
                <div className="item">
                  <div className="left-side">
                    <div className="title">
                      ...
                      <p>
                        Take pride as you watch your students grow and achieve
                ...
                <div className="item">
                  <div className="left-side">
                    <div className="title">
                      ...
                      <p>
                        Unlock the power of technology with AcadAlly, making
                        your leap into the digital age inspiring and effortless.
                      </p>
                    </div>
                    <div className="img">
                      <Image
              ...
              <div className="right-side">
                <div className="login-box">
                  ...
                  <form onSubmit={loginhandler}>
                    ...
                    {/* <Link href="/login/teacher/forgotusername">
                      Forgot Username?
                    </Link> */}
