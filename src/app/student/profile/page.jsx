...
import ProfilePage from "../../components/studentcomponent/ProfilePage";
...
export default function StudentWeb() {
  ...
  useEffect(() => {
    const fetchBadgeProfile = async () => {
      try {
        ...
        const response = await axiosInstance.get("studentapis/badge_profile");
  ...
  return (
    <div className="student_container">
      ...
      >
        <ProfilePage subjectData={subjectData} />
      </div>
